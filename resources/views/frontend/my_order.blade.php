                ...
                <div class="d-block border rounded mfliud-bot">
                    <div class="dashboard_author px-2 py-5">
                        <div class="dash_auth_thumb circle p-1 border d-inline-flex mx-auto mb-2">
                            @if (Auth::guard('customerlogin')->user()->photo == null)
                                <img width="50" src="{{ Avatar::create(Auth::guard('customerlogin')->user()->name)->toBase64() }}" /></td>
                            @else
                    ...
                    <div class="dashboard_author">
                        ...
                        <ul class="dahs_navbar">
                            <li><a class="active" href="{{ route('my.order') }}"><i class="lni lni-shopping-basket mr-2"></i>My Order</a></li>
            ...
            <div class="col-12 col-md-12 col-lg-8 col-xl-8 text-center">
                ...
                <div class="ord_list_wrap border mb-4">
                    <div class="ord_list_head gray d-flex align-items-center justify-content-between px-3 py-3">
                        ...
                        <div>
                            <a href="{{ route('download.invoice', $order->id) }}" class="bg-success text-white px-3 py-1">Download invoice</a>
                        </div>
                        <div class="">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                                <div class="cart_single d-flex align-items-start mfliud-bot">
                                    ...
                                    <div class="cart_single_caption pl-3">
                                        <p class="mb-0"><span class="text-muted small">{{ App\Models\Category::where('id', $category_id)->first()->category_name }}</span></p>
                                        ...
                                        <h4 class="fs-sm ft-bold mb-0 lh-1">TK {{ $order_product->price }} X {{ $order_product->quantity }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
