                            ...
                            <ul>
                                @foreach ($categories as $category)
                                    <li><a href="{{ route('categories.product', $category->id) }}"><i
                                                class="{{ $category->icon }}"></i>{{ $category->category_name }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="smart-brand">
                        @foreach ($products as $product)
                            <div class="single-brnads text-center">
                                <h3 style="border-right: 1px solid #ee1c47 !important">{{ $product->brand }}</h3>
                            </div>
                        @endforeach
                    </div>
                </div>
                ...
                @foreach ($categories as $category)
                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-4">
                        <div class="cats_side_wrap text-center mx-auto mb-3">
                            <div class="sl_cat_01">
                                <div class="d-inline-flex align-items-center justify-content-center circle border"><a
                                        href="javascript:void(0);" class="d-block">
                                        <i style="font-size: 30px; width:70px;height:70px;line-height:70px"
                            ...
                            <div class="product_grid row">
                                ...
                                <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                                    <div class="text-left mfliud">
                                        <div class="elso_titl"><span
                                                class="small">{{ $best->rel_to_product->rel_to_cat->category_name }}</span>
                                        </div>
                                        <h5 class="fs-md mb-0 lh-1 mb-1 ft-medium"><a
                                                href="shop-single-v1.html">{{ $best->rel_to_product->product_name }}</a>
                                        </h5>
                                        <div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">
                                            @php
                                                $star = App\Models\OrderProduct::where('product_id', $best->product_id)
                                                    ->whereNotNull('review')
                                                    ->sum('star');
                                                $total_review = App\Models\OrderProduct::where('product_id', $best->product_id)
                                                    ->whereNotNull('review')
                                                    ->count();
                        ...
                        @foreach ($recent_viewed_product as $recent)
                            <div class="product_grid row">
                                ...
                                <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                                    <div class="text-left mfliud">
                                        <div class="elso_titl"><span
                                                class="small">{{ $recent->rel_to_cat->category_name }}</span>
                                        </div>
                                        <h5 class="fs-md mb-0 lh-1 mb-1 ft-medium"><a
                                                href="shop-single-v1.html">{{ $recent->product_name }}</a></h5>
                                        <div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">
                                            @php
                                                $star = App\Models\OrderProduct::where('product_id', $recent->id)
                                                    ->whereNotNull('review')
                                                    ->sum('star');
                                                $total_review = App\Models\OrderProduct::where('product_id', $recent->id)
                                                    ->whereNotNull('review')
                                                    ->count();
