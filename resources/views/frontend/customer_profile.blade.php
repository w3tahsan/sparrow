                    ...
                    <form class="row m-0" action="{{ route('customer.profile.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ Auth::guard('customerlogin')->user()->email }}" name="email" class="form-control" placeholder="dhananjay7@gmail.com" />
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="old_password" class="form-control" placeholder="Current Password" />
                            </div>
                        </div>
