...
<body>
    ...
    <script type="text/javascript">
        ...
        (function() {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/63bd4b8947425128790ca552/1gmdmu4uu';
            s1.charset = 'UTF-8';
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
                        ...
                        @else
                            <div class="currency-selector dropdown js-dropdown float-right mr-3">
                                <a href="{{ route('customer.reglogin') }}" class="text-muted medium"><i
                                ...
                                <div class="headd-sty-02 ml-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="search_input" name="search_input"
                                            class="form-control custom-height b-0" value="{{ @$_GET['q'] }}">
                            ...
                            <div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
                                <div class="cart_single d-flex align-items-center">
                                    ...
                                    <div class="cart_single_caption pl-2">
                                        ...
                                        <p class="mb-2">Qty: <span
                                                class="text-dark ft-medium small">{{ $cart->quantity }}</span></p>
    ...
    <script>
        $('#search_btn').click(function() {
            ...
            var max = $('#max').val();
            var sort = $('#sort').val();
            var link = "{{ route('search') }}" + "?q=" + search_input + "&category_id=" + category_id +
                "&color_id=" + color_id + "&size_id=" + size_id + "&min=" + min + "&max=" + max + "&sort=" + sort;
